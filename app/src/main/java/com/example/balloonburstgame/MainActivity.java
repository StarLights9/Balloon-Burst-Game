...
public class MainActivity extends AppCompatActivity {
    ...
    Runnable runnable;
    Handler handler;
    private ImageView[] balloonArray;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewTime = findViewById(R.id.textViweTime);
    ...
    public void balloonsControl() {
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                ImageView[] balloonsArray = new ImageView[0];
                for (ImageView balloon : balloonsArray) {
                    balloon.setVisibility(View.INVISIBLE);
                    balloon.setImageResource(R.drawable.balloon1);
                }
                gridLayout.setVisibility(View.VISIBLE);
